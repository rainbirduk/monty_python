...
print("")
print("You have chosen box number", mh.box_text_dict[initial_choice])
...
print("Without opening your chosen box, the host proceeds to open box number", 
      mh.box_text_dict[host_hint], "to reveal that it is empty.")
...
while check[0].lower() == "n":
    ...
    if final_choice == initial_choice:
        print("Are you sure you want to stick with box number", mh.box_text_dict[initial_choice])
    else:
        print("Are you sure you want to switch from box number", mh.box_text_dict[initial_choice],
              "to box number", mh.box_text_dict[final_choice])
...
print("")
if outcome:
    print(f"You win! The winning box was indeed box number {mh.box_text_dict[winning_box]}!")
    print("Thanks for playing. Enjoy your sports bike.")
else:
    print(f"You have lost :( The winning box was box number {mh.box_text_dict[winning_box]}.")
